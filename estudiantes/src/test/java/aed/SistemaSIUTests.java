...
public class SistemaSIUTests {
    ...
    void cerrar_materia(){
        ...
        realizar_inscripciones(sistema);
        ///////
        System.out.println(Arrays.toString(sistema.materias("Ciencias de Datos")));
        System.out.println(Arrays.toString(sistema.materias("Ciencias de la Computación")));
        ////////
        ...
        String[] mateDatos = sistema.materias("Ciencias de Datos");
    ...
    void cerrar_facultad(){
        ...
        ///////
        System.out.println(Arrays.toString(sistema.materias("Ciencias de Datos")));
        System.out.println(Arrays.toString(sistema.materias("Ciencias Químicas")));
        System.out.println(Arrays.toString(sistema.materias("Ciencias de la Computación")));
        System.out.println(Arrays.toString(sistema.materias("Ciencias Matemáticas")));
        ////////
